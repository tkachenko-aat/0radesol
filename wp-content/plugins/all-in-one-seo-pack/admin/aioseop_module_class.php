...
//			$this->plugin_path['dir'] = plugin_dir_path( $this->file );
		...
		/* !!!! */
		$types_arr = get_post_types( array('public' => true), 'objects' );  unset($types_arr['attachment'], $types_arr['wow_order'], $types_arr['c_form_order']);
			return $this->get_object_labels( $types_arr );
		}
