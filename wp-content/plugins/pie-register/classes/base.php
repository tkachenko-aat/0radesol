...
class PieReg_Base
{
	...
	function install_settings()
	{
		...
		{
			$_p = array();
			$_p['post_title'] 		= __("Pie Register - Login");
			$_p['post_name'] 		= 'login';
		...
		{
			$_p = array();
			$_p['post_title'] 		= __("Pie Register - Registration");
			$_p['post_name'] 		= 'registration';
		...
		{
			$_p = array();
			$_p['post_title'] 		= __("Pie Register - Forgot Password");
			$_p['post_name'] 		= 'forgot-password';
		...
		{
			$_p = array();
			$_p['post_title'] 		= __("Pie Register - Profile");
