...
<?php /* Зміна кількості товарів у кошику і на сторінці товару */ ?>
 function qty_chan(par, qty_id, pagee) {		   
		   ...
		   item_qty.value = qtyy;
			...
			if (pagee == 'checkout') {
			document.getElementById("button_update_checkout").style.display = "block";
			document.getElementById("button_checkout").style.display = "none";		
			}	
}  
...
<?php /* Конт. форма. Повідомлення про виконання - у спливаючому вікні "lightb_contact_form_call_me" */ ?>
