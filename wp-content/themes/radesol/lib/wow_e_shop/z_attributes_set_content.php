...
if( ($_REQUEST['page'] == 'wow_attributes_set') and (isset($_POST['name']) or isset($_POST['s_code']) or isset($_POST['s_delete'])) ) : 
	...
	$atr_set_arr = array('entity_id' => 1, 'is_no_product' => $_POST['is_no_product'], 'set_post_type' => $_POST['set_post_type'], 'name' => $_POST['name'], 'position' => $_POST['position'], 'unit' => $_POST['unit']);
	...
	if($_POST['name']) {
	$atr_set_arr = array('set_post_type' => $_POST['set_post_type'], 'name' => $_POST['name'], 'position' => $_POST['position'], 'unit' => $_POST['unit']);
...
<?php } ?>
        ...
        <div class="field_24"><label for="unit"><?php echo __('Unit'); ?></label> <input type="text" name="unit" id="unit" size="30" value="<?php echo $atr_set_data['unit'] ?>" /> <span>E.g., kilogram, meter</span> </div>
        </div>
...
<div class="post_type a_right" style=" float:right;">
