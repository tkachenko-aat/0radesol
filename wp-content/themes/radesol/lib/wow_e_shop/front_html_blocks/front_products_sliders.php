<?php 
$prod_sliders_mode = 0; // 0 - slider, 1 - simple products list

$sliders_class_1 = 'hslider-container';  $sliders_class_2 = 'horizontal-slider';
if($prod_sliders_mode == 1) { 
$sliders_class_1 = 'prod-list-2';  $sliders_class_2 = 'grid_cont'; 
}
...
<div class="box-content co_<?php echo $prod_type ?> <?php if($prod_sliders_mode==1) { ?>maine<?php } ?>">
...
<div class="<?php echo $sliders_class_1 ?>"> <?php /* "hslider-container", "prod-list-2" */ ?>
<?php if($prod_sliders_mode == 0) { ?> 
...
<?php } ?>       
   	...
   	<div class="<?php echo $prod_type ?> <?php echo $sliders_class_2 ?>"> <?php /* 'horizontal-slider', 'grid_cont' */ ?>       
			
            <ul<?php if($prod_sliders_mode == 1) { ?> class="products-list"<?php } ?>>                
	...
	<div class="prod-center">
        ...
        <h5 class="product-name"><a href="<?php the_permalink(); ?>" title="<?php // the_title(); ?>" aria-label="<?php echo samorano_short_content($content, $cutti_num); ?>"><?php echo the_title(); ?></a></h5><?php if($prod_sliders_mode == 1) { ?><div class="entry-content"><?php the_content(); ?></div><?php } ?>
  ...
  // include WOW_DIRE.'front_html_blocks/attributes.php'; /* wow_e_shop *** attributes *** */ ?>
    ...
    <?php if($prod_sliders_mode == 0) : if($prod_s_query->post_count > 1) : ?>
 <div class="hslider-nav hslider-prev <?php echo $prod_type ?>"> <i class="ha ha-arrow ha-arrow-left"></i> </div>
 <div class="hslider-nav hslider-next <?php echo $prod_type ?>"> <i class="ha ha-arrow ha-arrow-right"></i> </div>
