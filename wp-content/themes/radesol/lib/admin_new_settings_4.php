...
function sett_5_1_title_input() {
	$options = get_option('settings_5_arr');	$value = $options['sett_5_1_title'];
	echo '<input type="text" id="sett_5_1_title" name="settings_5_arr[sett_5_1_title]" value="'.$value.'" size="60" /> ';
}

function sett_5_1_comment1_input() {
	$options = get_option('settings_5_arr');	$value = $options['sett_5_1_comment1'];
	echo '<input type="text" id="sett_5_1_comment1" name="settings_5_arr[sett_5_1_comment1]" value="'.$value.'" size="60" /> ';
}

function sett_5_1_unit_input() {
	$options = get_option('settings_5_arr');	$value = $options['sett_5_1_unit'];
	echo '<input type="text" id="sett_5_1_unit" name="settings_5_arr[sett_5_1_unit]" value="'.$value.'" size="60" /> ';
}
