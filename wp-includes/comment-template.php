...
function get_comment_id_fields( $id = 0 ) {
	...
	$result .= "<input type='hidden' name='post_url' id='post_url' value='$post_url' />\n"; /* !!!! */
...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . __( 'Comment' ) . '</label> <textarea id="comment" name="comment" cols="45" rows="8" maxlength="65525" aria-required="true" required="required"></textarea></p>',
